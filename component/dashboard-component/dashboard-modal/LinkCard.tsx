...
export default function LinkCard(props: any) {
    return (
        <div style={{width : '560px'}} className='bg-white px-8 h-screen'  >
            ...
            <p className='font-Inter-Medium text-base' >Link Card 💳</p>
            ...
            <div className='mt-10' >
                ...
                <button style={{backgroundColor: '#002343'}} className='w-full rounded-lg text-white py-3 mt-8 text-sm font-Montserrat-Medium ' >PROCEED TO LINK CARD 🔒</button>
            </div>
        </div>
    );
}
