...
export default function Payment(props: any) {
    ...
    return (
        <div style={{width : '560px'}} className='bg-white h-screen px-8 pb-10 overflow-y-auto font-Montserrat-Regular '  >
            ...
            {selected !== '' ?
                <>
                    ...
                    <button onClick={()=> props.close(4)} style={{backgroundColor: '#002343', borderRadius: '2px'}}  className=' w-full mt-10 text-white font-Montserrat-Bold text-sm h-12 items-center justify-center' >PROCEED</button>
                </>
            :null}
        </div>
    )
