    ...
    return (
        <div className='w-full h-full py-10 px-14'> 
            <div className='w-full flex items-center'>
                <p className='font-Montserrat-Bold text-base ' >{tab === 1 ? 'ID Image' :tab === 2 ? 'Other Document':'Account Verification'}</p> 
                ...
                <p style={{color: '#03C8DB'}} className='font-Montserrat-Medium ml-1 text-sm ' >Learn more</p> 
            </div> 
