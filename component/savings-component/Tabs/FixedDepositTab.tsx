...
export default function FixedDepositTab(props: any) { 
    ...
    React.useEffect(() => { 
        ...
        formik.setFieldValue('duration', catergory)

    },[catergory, endModal])  

    React.useEffect(() => { 
        // '3 months','6  months','1 year','2 years'
        if(catergory === '3 months'){
            setNumber(3)
        } else if(catergory === '6 months'){
            setNumber(3)
        } else if(catergory === '1 year'){
            setNumber(12)
        } else if(catergory === '2 years'){
            setNumber(24)
        }
    }, )
        ...
        <div className='w-full flex-col lg:flex-row flex mb-10' >
            ...
            <div className='w-full lg:mx-3 mt-8 lg:mt-0'> 
                ...
                <label>
                    ...
                    <div style={{backgroundColor: '#CDF4F8', height: '160px', borderRadius: '8px'}} className='w-full flex justify-center items-center cursor-pointer my-8' >
                        {image === '' ?
            ...
            {showModal ?  
                <FixedDepositController value={value} image={image} month={number} close={setShowModal} end={setEndModal} />
            :null}
        </div>
    )
}
