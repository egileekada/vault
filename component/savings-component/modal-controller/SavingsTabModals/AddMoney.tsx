    ...
    return (
        <div  className=' w-full lg:w-560px bg-white pb-8 px-8 h-screen overflow-y-auto'  >
            ...
            <div className='w-full grid grid-cols-1 lg:grid-cols-2 gap-4 mt-2' > 
                ...
                <div onClick={()=> props.next(2)} style={{border: '1px solid #CCD3D9', color: '#828282'}} className='w-full h-40 p-3 flex cursor-pointer justify-center items-center rounded-lg' >
                        <IoIosAdd size='50px' />
                </div>
            </div>
