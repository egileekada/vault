            ...
            <div className='w-full h-full flex justify-center items-center  ' >
                <div className='bg-white w-full h-full flex justify-center flex-col py-24  py-14 px-6 lg:px-40 rounded-lg' >
                    ...
                    <div className='w-full mt-8' >
                        <p className='font-Inter-Medium text-xs ' >Don't Have An Account? <Link style={{ textDecoration: 'none' }} href='/signup'><span className='cursor-pointer ml-1 font-Inter-SemiBold text-xs' style={{color:'#03C8DB'}} >Create an Account</span></Link></p>
                    </div>
                </div>
            </div> 
